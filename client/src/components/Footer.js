            ...
            <Container>
                <Row className="d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <Col md={4} className="d-flex justify-content-center mb-3 mb-md-0">
                        <a href="/" className="d-flex align-items-center justify-content-center link-body-dark text-decoration-none text-dark">
                    ...
                    <Col md={4}>
                        <Nav className="justify-content-end">
                            <Nav.Item>
                                <Nav.Link href="https://github.com/dev-skipo" className="px-2 text-body-secondary"><i class="bi bi-github"></i> GitHub</Nav.Link>
                            </Nav.Item>
                        </Nav>
                    </Col>
                </Row>
